...
Read the <a href="https://telegra.ph/Clonebot-UI-Help-05-30" target="_blank"> documentation </a>to know how to use the bot
<br>
<p align="left">
    <br>
    ...
    <br>
        2. Change the <a href="https://github.com/MR-X-MIRROR-BOTZ/MR-X-CLONE-BOT/blob/master/app.json#L7" target="_blank"> app.json </a> 'repository' URL to your fork URL.
    <br>
